...
def interpolation(lon, lat, points, size):
    """
    idw
    :param lon: 未知点经纬度
    :param lat: 未知点经纬度
    ...
    p = 1
    result = 0.0
    _denominator = denominator(point_zero, points, p, size)
    lambda_sum = 0.0
    for point in points:
        molecular = distance(point, point_zero) ** -p
...
def denominator(point_zero, points, p, size):
    """
...
if __name__ == '__main__':
    ...
    print(interpolation(110.0, 150.0, all_points, len(all_points)))
